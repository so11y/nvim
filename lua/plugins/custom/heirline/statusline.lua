...
components.RightPadding(components.ShowCmd), -- components.RightPadding(components.LSPActive),
components.RightPadding(components.LspProgress, 1), components.RightPadding(components.Formatters, 1),
-- components.RightPadding(components.SimpleIndicator),
components.RightPadding(components.FileType, 0), components.RightPadding(components.Ruler, 1), components.ScrollBar}
